...
{  
public:  
    virtual void A(float ival)    //覆盖父类的A：函数名、参数完全相同，且父类一定要有virtual  
    {
        cout<< " CDerive::A() ";
    }      
...
//    int A(int ival)
//  	{
//  		cout << "CDerive::A()  return int ";
//  	}
/*
隐藏.cpp:20:9: error: conflicting return type specified for ‘virtual int CDerive::A(int)’
     int A(int ival)
         ^
隐藏.cpp:6:18: error:   overriding ‘virtual void CBase::A(int)’
     virtual void A(int ival){cout <<" CBase::A() ";}  
                  ^
*/
