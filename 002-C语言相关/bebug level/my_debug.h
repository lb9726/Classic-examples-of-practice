...
*/
 ...
 //__my_unallow_debug最终的结果为真或假，取决于后面的表达式的参数大小的比较结果
 ...
 // 如果__my_unallow_debug(SECTION, DEBUG_LEVEL) 为真则不打印log，否则替换为__my_debug，进行log的输出
...
这两个函数的前两个参数要保持相同即可比较出结果，并且要保证my_init_debug_levels的后一个参数比my_debug的后一个参数大即可打印log 
*/
